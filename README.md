<meta http-equiv="refresh" content="0; url=https://twikoo.js.org/pushoo.html">

# pushoo.js

> **pushoo 已并入 [Twikoo](https://github.com/twikoojs/twikoo) 仓库（`packages/pushoo`），本仓库不再维护。**
> 文档请见 **<https://twikoo.js.org/pushoo.html>**。

## 变更说明

- **代码仓库**：原 `imaegoo/pushoo` → `twikoojs/twikoo` 的 `packages/pushoo`
- **文档**：原 pushoo.js.org → <https://twikoo.js.org/pushoo.html>
...
(`packages/pushoo`) and is released from there. Documentation:
**<https://twikoo.js.org/en/pushoo.html>**.
